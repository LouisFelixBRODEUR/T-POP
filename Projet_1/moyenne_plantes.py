...
accuracy_moyenne, accuracy_std = evaluer_modele(X_scaled, y_encoded, nb_plantes=10, repetitions=10, afficher_confusion=True)

# Affichage du graphique de précision (sans matrices de confusion supplémentaires)
graphique_precision(X_scaled, y_encoded, max_plantes=10, repetitions=10)